...
/** PRINTS ADMINISTRATOR VIEW OF FORM TO ADD A MOTORSPORT EVENT FORECAST **/
		...
		<div class='right_bg'>
			<div class='right'>
				<div class='MTA'>
					...
					include("validateUpdateMotorsportEventsForm.php");
                    echo "<form name='updateUKDailyForecast' id='updateUKDailyForecast' action='' method='post'>
                        ...
                        <tr>
                        	<td class='submitArea' colspan='2'>
								<input type='hidden' name='formName' id='formName' value='motorsport' />
								<input class='buttonSubmit' type='submit' name='buttonUpdate_specialEvents_motorsport' id='buttonUpdate_specialEvents_motorsport' value='Update Forecast'  />
							</td>
                        </tr>
                    </table>
					</form>
                    ...
                    /**<h3>Delete a Forecast</h3><br/>";
						include("validateDeleteMotorsportEventsForm.php");
                    echo " <form name='deleteUKDailyForecast' id='deleteUKDailyForecast' action='' method='post'>
                        ...
                        <tr>
                        	<td class='submitArea' colspan='2'><input class='buttonSubmit' type='submit' name='buttonUpdate_specialEvents_motorsport_delete' id='buttonUpdate_specialEvents_motorsport_delete' value='Delete Forecast'  /></td>
                        </tr>
                    </table>
					</form>";**/
					include("displayAdministratorMotorsportEvents.php");
				echo "</div>
			</div>
		</div>
	</div>

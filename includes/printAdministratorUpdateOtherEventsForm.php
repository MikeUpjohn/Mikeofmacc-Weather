...
/** PRINTS ADMINISTRATOR VIEW OF FORM TO ADD OTHER EVENT FORECASTS **/
			...
			<div class='right'>
				<div class='MTA'>
					<h3>Add New Forecast</h3><br/>";
						include("validateUpdateOtherEventsForm.php");
                    ...
                    /**<h3>Delete a Forecast</h3><br/>";
                    	include("validateDeleteOtherEventsForm.php");
                    echo "<form name='deleteUKDailyForecast' id='deleteUKDailyForecast' action='' method='post'>
						...
						include("displayAdministratorOtherEvents.php");
				echo "</div>
			</div>
		</div>
	</div>

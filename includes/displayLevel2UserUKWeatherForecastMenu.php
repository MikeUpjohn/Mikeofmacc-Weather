...
/** PRINTS USER VIEW LEVEL 2 UK WEATHER FORECAST MENU **/
echo "
	<div class='menu'>
			<ul>
				<li><a href='../index.php'>Home</a></li>
				<li><a href='index.php'>UK Weather Forecast</a>
					<ul>
						<li><a href='index.php'><strong>UK Forecasts Home</strong></a></li>
						<li><a href='dailyforecast.php'>Daily Forecast</a></li>
						<li><a href='weekendforecast.php'>Weekend Lookahead</a></li>
					</ul>
				</li>

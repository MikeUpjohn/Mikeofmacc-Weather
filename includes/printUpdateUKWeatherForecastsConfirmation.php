...
echo "<div class='unauthorised_container'>
		<div class='unauthorised_right'>
			...
			<h3>Our system indicates that you are not correctly logged into the system. This could be due to a timeout as a result of session inactivity. Please try logging in again. This page will return to the home page shortly.</h3>

...
/** DISPLAY ADMINISTRATOR VIEW OF LEVEL 2 SEVERE WEATHER FORECAST MENUS **/
echo "
	<div class='menu'>
			<ul>
				...
				<li><a href='#'>Severe Weather Forecasts</a>
					<ul>
						...
						<li><a href='convectiveforecast.php'>Convective/T'storm Forecasts<strong>[Edit]</strong></a></li>
						<li><a href='snowandiceforecast.php'>Snow/Ice Forecasts<strong> [Edit]</strong></a></li>
						<li><a href='galeforecast.php'>Gale/High Wind Forecasts<strong> [Edit]</strong></a></li>
					</ul>
				</li>
			</ul>
	</div>";

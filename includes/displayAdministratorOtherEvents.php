...
/** DISPLAY ADMINISTRATOR VIEW OF ANY OTHER EVENTS **/
...
if(!$result) {
	...
	if($numberOfResults == 0) {
		...
		while($row = mysql_fetch_array($result)) {
			...
			echo "<td><a href='edit.php?forecastType=other&forecastID=" . $row['forecastID'] . "'>[Edit]</a>
						<a href='delete.php?forecastType=other&forecastID=" . $row['forecastID'] . "'>[Delete]</a></td>";
			echo "</tr>";
		}
		echo "</table>";
	}

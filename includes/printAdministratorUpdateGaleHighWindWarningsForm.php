...
/** PRINTS ADMINISTRATION VIEW OF THE FORM TO ADD AND DELETE GALE AND HIGH WIND WEATHER WARNINGS **/
echo "<div class='container'>
	<div class='banner'>
        ...
        <div class='header_text'>
            ...
            <h3>Gale &amp; High Wind Forecasts</h3>
        </div>
	</div>
            	...
            	<div class='ukDailyForecast'>
                    <div class='MTA'>
						<h3>Add New Weather Warning</h3><br/>";
							include("validateUpdateGaleHighWindWarningsForm.php");
						echo "<form name='addGaleHighWindWarning' id='addGaleHighWindWarning' method='post' action=''>
						<table align='center' border='0' class='administration' width='80%'>
							...
							<tr>
								<td class='submitArea' colspan='2'>
									...
									name='buttonAdd_severeWeatherForecast_galeHighWindWarning' 
									id='buttonAdd_severeWeatherForecast_galeHighWindWarning'
									value='Issue Warning' />
								</td>
							</tr>
						</table>
						...
						<h3>Expire a Warning</h3><br/>";
							include("validateDeleteGaleHighWindWarningsForm.php");
						echo "<form name='deletegaleHighWindWarning' id='deleteGaleHighWindWarning' action='' method='post'>
						<table align='center' border='0' class='administration' width='80%'>
							<tr>
							...
							<tr>
								<td class='submitArea' colspan='2'>
									<input class='buttonSubmit' type='submit'
									name='buttonUpdate_severeWeatherForecasts_galeHighWindWeatherWarnings_Delete'
									id='buttonUpdate_severeWeatherForecasts_galeHighWindWeatherWarnings_Delete'
									value='Delete' />
								</td>
							</tr>
						</table>
					</form>";
					include("displayAdministratorGaleHighWindWarnings.php");
					echo "</div>
                </div>
            </div>
        </div>

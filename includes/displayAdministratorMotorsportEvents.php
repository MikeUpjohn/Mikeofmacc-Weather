...
/** PRINTS ADMINISTRATOR VIEW OF MOTORSPORT EVENTS **/
$query = "SELECT * FROM specialevents_motorsportevents";
...
if(!$result) {
	...
	if($numberOfResults == 0) {
		...
		while($row = mysql_fetch_array($result)) {
			...
			echo "<td><a href='edit.php?forecastType=motorsport&forecastID=" . $row['forecastID'] . "'>[Edit]</a>
						<a href='delete.php?forecastType=motorsport&forecastID=" . $row['forecastID'] . "'>[Delete]</a></td>";
			echo "</tr>";
		}
		echo "</table>";
	}

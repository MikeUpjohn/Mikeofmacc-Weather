...
if(isset($_POST['buttonEdit_specialEvents'])) {
	$errorMessage = "";
	$submitForm = true;
	...
	if($submitForm == true) {
		//echo "<meta http-equiv='refresh' content='0;url=../../includes/updateSpecialEventsForecast.php?forecastType=" . $_POST['updateType'] . "&forecastID=" . $_POST['forecastID'] . "' >";
		include("updateSpecialEventsForecast.php");
	}
	else {

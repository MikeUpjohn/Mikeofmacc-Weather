...
/** PRINTS USER VIEW OF ALL CONVECTIVE AND THUNDERSTORM WEATHER WARNINGS **/
...
if(!$result) {
	...
	if($numrows == 0) {
		echo "<h4><strong>Convective/Thunderstorm Warnings</strong></h4>";
		echo "<p>No convective/thunderstorm warnings currently issued. Please check again later.</p>";
	}
	else {

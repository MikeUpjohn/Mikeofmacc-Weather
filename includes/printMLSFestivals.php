...
if(!$result) {
	...
	if($currentNumberOfForecasts == 0) {
		echo "<h4><strong>Festivals of Music, Light and Sound Forecasts</strong></h4>";
		echo "<p>No Festivals of Music, Light and Sound forecasts issued at present. Please check back later.</p>";
	}
	else {

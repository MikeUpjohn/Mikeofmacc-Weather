...
echo "<div class='container'>
	<div class='banner'>
		...
		<div class='header_text'>
			...
			<h3>UK Weather Forecast - Update Weekend Forecast</h3>
		</div>
	</div>
	<div class='main_container'>
		<div class='left_bg'>
			<div class='left'>
				<div class='menu'>";
						include("displayLevel2AdministratorUKWeatherForecastMenus.php");
				echo "</div>
			</div>
		</div>
		<div class='right_bg'>
			<div class='right'>
				<div class='MTA'>";
				include("validateUpdateWeekendForecastForm.php");
				echo "<form name='updateUKDailyForecast' id='updateUKDailyForecast' action='' method='post'>
					<table align='center' border='0' class='administration' width='80%'>    
                      	<tr>
                       		<td class='leftColumn'>Start Date of Forecast:</td>
                           	<td class='dataColumn'><input class='long' type='text' name='forecastStartDate' id='forecastStartDate' value='' /></td>
                   		</tr>
                        <tr>
                       		<td class='leftColumn'>End Date of Forecast:</td>
                           	<td class='dataColumn'><input class='long' type='text' name='forecastEndDate' id='forecastEndDate' value='' /></td>
                   		</tr>
                        <tr>
                        ...
                        <tr>
                       		<td class='leftColumn'>Issue Time (hh:mm):</td>
                        ...
                        <tr>
                        	<td class='submitArea' colspan='2'><input type='submit' class='buttonSubmit' name='buttonUpdate_weekendForecast' id='buttonUpdate_weekendForecast' value='Update Forecast' /></td>
                        </tr>
                    	</table>
					</form>
				</div>

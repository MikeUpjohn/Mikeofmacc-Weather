...
/** DISPLAYS ADMINISTRATOR VIEW OF GALE AND HIGH WIND FORECASTS **/
...
if(!$result) {
	...
	if($numberOfResults == 0) {
		...
		while($row = mysql_fetch_array($result)) {
			...
			echo "
				<td>
					<a href='edit.php?forecastType=galeHighWind&forecastID=" . $row['forecastID'] . "'>[Edit]</a>
					<a href='delete.php?forecastType=galeHighWind&forecastID=" . $row['forecastID'] . "'>[Delete]</a>
				</td>";
			echo "</tr>";
		}
		echo "</table>";

...
/** PRINTS ADMINISTRATOR VIEW OF FORM TO ADD A SAILING EVENT FORECAST **/
...
echo "<div class='container'>
	<div class='banner'>
		...
		<div class='header_text'>
			...
			<h3>Special Events Forecasts - Update Sailing Events</h3>
		</div>
	</div>
			...
			<div class='right'>
				<div class='MTA'>
					<h3>Add New Forecast</h3><br/>";
						include("validateUpdateSailingEventsForm.php");
                    echo "<form name='updateUKDailyForecast' id='updateUKDailyForecast' action='' method='post'>
                        ...
                        <tr>
                        	<td class='submitArea' colspan='2'><input class='buttonSubmit' type='submit' name='buttonUpdate_specialEvents_sailing' id='buttonUpdate_specialEvents_sailing' value='Update Forecast'  /></td>
                        </tr>                        
                    </table>
					</form>
                    ...
                    /**<h3>Delete a Forecast</h3><br/>";
						include("validateDeleteSailingEventsForm.php");
                    echo "<form name='deleteUKDailyForecast' id='deleteUKDailyForecast' action='' method='post'>
                        ...
                        <tr>
                        	<td class='submitArea' colspan='2'><input class='buttonSubmit' type='submit' name='buttonUpdate_specialEvents_sailing_delete' id='buttonUpdate_specialEvents_sailing_delete' value='Delete Forecast'  /></td>
                        </tr>
                    
                    </table>
					</form>";**/
						include("displayAdministratorSailingEvents.php");
				echo "</div>
			</div>
		</div>
	</div>

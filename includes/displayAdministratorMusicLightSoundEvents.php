...
/** ADMINISTRATOR VIEW OF MUSIC, LIGHT AND SOUND EVENTS **/
$query = "SELECT * FROM specialevents_mlsfestivals";
...
if(!$result) {
	...
	if($numberOfResults == 0) {
		...
		while($row = mysql_fetch_array($result)) {
			...
			echo "<td><a href='edit.php?forecastType=mlsFestivals&forecastID=" . $row['forecastID'] . "'>[Edit]</a>
						<a href='delete.php?forecastType=mlsFestivals&forecastID=" . $row['forecastID'] . "'>[Delete]</a></td>";
			echo "</tr>";
		}
		echo "</table>";
	}

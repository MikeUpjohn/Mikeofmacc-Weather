...
echo "<div class='container'>
	...
	<div class='main_container'>
		<div class='left_bg'>
			<div class='left'>
				<div class='menu'>";
						writeMenuLevel2SpecialEventForecastAdmin();
				echo "</div>
			</div>
		</div>
		<div class='right_bg'>
			<div class='right'>
				<span class='MTA'>
                    ...
                    <form name='updateUKDailyForecast' id='updateUKDailyForecast' action='confirmation.php' method='post'>
                      	<tr>
                        ...
                        <tr>
                            ...
                            <td class='dataColumn'><textarea class='largeText' name='synopsis' id='synopsis'></textarea></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                        	<td class='submitArea' colspan='2'><input class='buttonSubmit' type='submit' name='buttonUpdate_specialEvents_other' id='buttonUpdate_specialEvents_other' value='Update Forecast'  /></td>
                        </tr>                        
					</form>
                    </table>
                    <div class='horizontal_rule'>
                    </div>
                    <h3>Delete a Forecast</h3>
                    <p>Using the Forecast ID, delete an appropriate forecast.</p><br/>
                    <table align='center' border='0' class='administration' width='80%'>
                    <form name='updateUKDailyForecast' id='updateUKDailyForecast' action='confirmation.php' method='post'>
                      	<tr>
                        ...
                        <tr>
                        	<td class='submitArea' colspan='2'><input class='buttonSubmit' type='submit' name='buttonUpdate_specialEvents_other_delete' id='buttonUpdate_specialEvents_other_delete' value='Delete Forecast'  /></td>
                        </tr>
                    </form>
                    </table>";
						printOtherEventsAdmin();
				echo "</span>
			</div>
		</div>
	</div>
	...
	<div class='footer'>
		...
		document.write('<strong>Last Modified: </strong>' + document.lastModified);
		</script>
		</div>
